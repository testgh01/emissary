...
public class Startup {
    ...
    private static final String PARALELL_PLACE_STARTUP_CONFIG = "PARALELL_PLACE_STARTUP";
    ...
    protected boolean placeSetup(final int directoryActionArg, final Map<String, String> localDirectoriesArg, final Map<String, String> placesArg,
        ...
        final Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                runPlaceSetup(directoryActionArg, localDirectoriesArg, placesArg, hostParameters);
            }
        });
    ...
    protected void runPlaceSetup(int directoryActionArg, Map<String, String> localDirectoriesArg, Map<String, String> placesArg,
            List<String> hostParameters) {
        ...
        boolean paralellPlaceStartup = hostsConfig.findBooleanEntry(PARALELL_PLACE_STARTUP_CONFIG, false);
        Stream<String> hostParametersStream = StreamSupport.stream(hostParameters.spliterator(), paralellPlaceStartup);
        logger.info("Parallel startup place flag {}", hostParametersStream.isParallel());
